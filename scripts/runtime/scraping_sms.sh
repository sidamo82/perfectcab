...
/usr/local/bin/Skyscraper -p mastersystem -c /usr/local/etc/skyscraper/config.ini -i /media/perfectcab/roms/sms -s arcadedb --cache refresh --flags unattend,skipped,unpack,videos
/usr/local/bin/Skyscraper -p mastersystem -c /usr/local/etc/skyscraper/config.ini -i /media/perfectcab/roms/sms -s screenscraper --cache refresh --flags unattend,skipped,unpack,videos
