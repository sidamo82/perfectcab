...
cp -r attract.* emulators/ intro/ romlists/ screensaver/ /usr/local/share/attract/
echo $PASSWORD | sudo -S chown -R user.user /usr/local/share/attract/
...
echo $PASSWORD | sudo -S /usr/local/src/perfectcab/software/lrmc-0.9.2/configure --prefix=/usr/local
